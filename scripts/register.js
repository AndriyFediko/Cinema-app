...
const validatePassword = () => {
    ...
    passwordInput.style.borderColor = "#52c41a";
    return true;
};
...
const validateName = () => {
    ...
    nameInput.style.borderColor = "#52c41a";
    return true;
};

const validatePasswordConfirm = () => {
    if (passwordInput.value !== passwordConfirmInput.value || passwordConfirmInput.value === "") {
        passwordConfirmInput.style.borderColor = "#ff4d4f";
        return false;
    }
    passwordConfirmInput.style.borderColor = "#52c41a";
    return true;
};
...
passwordInput.addEventListener("input", () => {
    validatePassword();
    if (!isLoginMode && passwordConfirmInput.value.length > 0) {
